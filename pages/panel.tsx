...
const panel = () => {
  ...
  return (
    <PanelLayout>
      <div className={styles.container}>
        ...
        >
          ...
          <div>
            ...
            <div>
              <p>
                Каждый пользователь может поливать Большое Древо один раз в
                сутки. На следующий день в зависимости от того сколько тотал
                полили дерево сотрудники отдела/команды они получают рандомные
                награды с определенными шансами (Gems/Nft на кофе/Nft
                горшков/Water токены).
              </p>
              <p>
                Такая механика обеспечит ликвидность water токенов и повысит
                вовлеченность коллектива и сплотит коллектив перед одной целью
                так как количество и шансы выпадения призов зависят от уровня
                того сколько полили дерево
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <img src="https://cdn.discordapp.com/attachments/934798571688054914/1028465503695536128/unknown.png" alt="" />
      </div>
    </PanelLayout>
  );
};
